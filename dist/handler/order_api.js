...
var order_Model = new order_1.OrderModel();
var index = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, order_Model.index()];
            case 1:
                orders = _a.sent();
                res.json(orders);
                return [3 /*break*/, 3];
...
var find = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, order_Model.find(id)];
            case 2:
                order = _a.sent();
...
var create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, order_Model.create(o)];
            case 2:
                newOrder = _a.sent();
...
var update = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, order_status, order, err_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = parseInt(req.params.id);
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, order_Model.update(id, order_status)];
            case 2:
                order = _a.sent();
                res.status(201).json(order);
                return [3 /*break*/, 4];
...
var delete_ = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, order_Model["delete"](id)];
            case 2:
                order = _a.sent();
                res.status(201).json(order);
                return [3 /*break*/, 4];
...
var addToCart = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var quantity, order_id, product_id, order, err_6;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                ...
                return [4 /*yield*/, order_Model.addOrderProduct(quantity, order_id, product_id)];
            case 1:
                order = _a.sent();
                res.json(order);
                return [3 /*break*/, 3];
...
var removeFromCart = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, order_Model.removeOrderProduct(parseInt(req.params.id))];
            case 1:
                deleted = _a.sent();
                res.json(deleted);
                return [3 /*break*/, 3];
...
var completedOrders = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, order_Model.completedOrders()];
            case 1:
                orders = _a.sent();
                res.json(orders);
                return [3 /*break*/, 3];
...
var ORDER_API = function (app) {
    app.get('/orders', verifyToken_1["default"], index);
    app.get('/order/:id', verifyToken_1["default"], find);
